...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_fixed_point" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1d846791#;
   pragma Export (C, u00001, "fixed_pointB");
   ...
   u00123 : constant Version_32 := 16#ecc88e78#;
   pragma Export (C, u00123, "system__fat_fltS");
   u00124 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00124, "system__img_biuS");
   u00125 : constant Version_32 := 16#5d024f66#;
   pragma Export (C, u00125, "system__img_decimal_128S");
   u00126 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00126, "system__img_llliS");
   u00127 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00127, "system__img_utilB");
   u00128 : constant Version_32 := 16#44802e3b#;
   pragma Export (C, u00128, "system__img_utilS");
   u00129 : constant Version_32 := 16#4a951815#;
   pragma Export (C, u00129, "system__img_decimal_32S");
   u00130 : constant Version_32 := 16#e53192c1#;
   pragma Export (C, u00130, "system__img_decimal_64S");
   u00131 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00131, "system__img_lliS");
   u00132 : constant Version_32 := 16#cdd5cca1#;
   pragma Export (C, u00132, "system__img_fixed_128S");
   u00133 : constant Version_32 := 16#83d1824d#;
   pragma Export (C, u00133, "system__arith_128B");
   u00134 : constant Version_32 := 16#88cbef47#;
   pragma Export (C, u00134, "system__arith_128S");
   u00135 : constant Version_32 := 16#c580fa16#;
   pragma Export (C, u00135, "system__exn_llliS");
   u00136 : constant Version_32 := 16#452f4f0f#;
   pragma Export (C, u00136, "system__img_fixed_32S");
   u00137 : constant Version_32 := 16#3a3869b5#;
   pragma Export (C, u00137, "system__arith_32B");
   u00138 : constant Version_32 := 16#af9af9ed#;
   pragma Export (C, u00138, "system__arith_32S");
   u00139 : constant Version_32 := 16#9448e622#;
   pragma Export (C, u00139, "system__exn_intS");
   u00140 : constant Version_32 := 16#47ae2d21#;
   pragma Export (C, u00140, "system__img_fixed_64S");
   u00141 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00141, "system__arith_64B");
   u00142 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00142, "system__arith_64S");
   u00143 : constant Version_32 := 16#2d8c0d8e#;
   pragma Export (C, u00143, "system__exn_lliS");
   ...
   u00146 : constant Version_32 := 16#cf061228#;
   ...
   u00148 : constant Version_32 := 16#c90890af#;
   pragma Export (C, u00148, "system__img_lfltS");
   u00149 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00149, "system__fat_lfltS");
   u00150 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00150, "system__img_lluS");
   u00151 : constant Version_32 := 16#0be1c959#;
   pragma Export (C, u00151, "system__powten_lfltS");
   u00152 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00152, "system__img_llbS");
   u00153 : constant Version_32 := 16#1422974c#;
   pragma Export (C, u00153, "system__img_llfS");
   u00154 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00154, "system__fat_llfS");
   u00155 : constant Version_32 := 16#b6fa998a#;
   pragma Export (C, u00155, "system__powten_llfS");
   u00156 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00156, "system__img_lllbS");
   u00157 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00157, "system__img_lllwS");
   u00158 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00158, "system__img_llwS");
   u00159 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00159, "system__img_wiuS");
   u00160 : constant Version_32 := 16#859b4914#;
   pragma Export (C, u00160, "system__val_decimal_128S");
   u00161 : constant Version_32 := 16#2e238de8#;
   pragma Export (C, u00161, "system__val_decimal_32S");
   u00162 : constant Version_32 := 16#cb2105aa#;
   pragma Export (C, u00162, "system__val_decimal_64S");
   u00163 : constant Version_32 := 16#8da8c7da#;
   pragma Export (C, u00163, "system__val_fixed_128S");
   u00164 : constant Version_32 := 16#0125f8d5#;
   pragma Export (C, u00164, "system__val_fixed_32S");
   u00165 : constant Version_32 := 16#f6b440a2#;
   pragma Export (C, u00165, "system__val_fixed_64S");
   u00166 : constant Version_32 := 16#18ee5867#;
   pragma Export (C, u00166, "system__val_fltS");
   u00167 : constant Version_32 := 16#8aea7eed#;
   ...
   u00170 : constant Version_32 := 16#0414e57b#;
   pragma Export (C, u00170, "system__val_lfltS");
   u00171 : constant Version_32 := 16#34ab9f34#;
   pragma Export (C, u00171, "system__exn_lfltS");
   u00172 : constant Version_32 := 16#de111da4#;
   pragma Export (C, u00172, "system__val_llfS");
   u00173 : constant Version_32 := 16#19055f44#;
   pragma Export (C, u00173, "system__exn_llfS");
   u00174 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00174, "system__val_llliS");
   u00175 : constant Version_32 := 16#f82486d6#;
